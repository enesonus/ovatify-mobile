...
object Images {
    ...
    const val POSTER_BASE_URL = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTspGEmlML92qIKTrL5q3GO2gf_TKXvojEHKS6QQo5Tbt4VUkGZGYnh8pwRGTvxD8ioTqE&usqp=CAU"
    ...
    const val imageUrl0 = POSTER_BASE_URL
    const val imageUrl1 = POSTER_BASE_URL
    const val imageUrl2 = POSTER_BASE_URL
    const val imageUrl3 = POSTER_BASE_URL
    const val imageUrl4 = POSTER_BASE_URL
    const val imageUrl5 = POSTER_BASE_URL
    const val imageUrl6 = POSTER_BASE_URL
    const val imageUrl7 = POSTER_BASE_URL
    const val imageUrl8 = POSTER_BASE_URL
    const val imageUrl9 = POSTER_BASE_URL
